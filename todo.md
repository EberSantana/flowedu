...
## Adequação de Layout - Página de Tarefas
- [x] Analisar padrão de layout das outras páginas (Subjects, Classes, etc)
- [x] Ajustar cabeçalho para seguir padrão (título com ícone, botão de ação)
- [x] Melhorar espaçamentos e margens (container mx-auto py-8)
- [x] Ajustar cores e bordas dos cards de tarefas (shadow-md, hover:shadow-lg, border-l-4)
- [x] Padronizar botões e formulários (Dialog, Select, Input)
- [x] Aplicar gradiente de fundo (from-teal-50 via-white to-cyan-50)
- [x] Usar PageWrapper para consistência
- [x] Ajustar layout dos cards de tarefas (flex items-start gap-3)
- [x] Melhorar estado vazio (Card com ícone e mensagem)
