...
export default function ExercisePerformanceReport() {
  ...
  const [appliedDateTo, setAppliedDateTo] = useState<string>(() => new Date().toISOString().split('T')[0]);
            ...
            <CardContent>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {[
                  ...
                  { label: '1º Bimestre', from: '-04-01', to: '-05-31' },
                  { label: '2º Bimestre', from: '-06-01', to: '-07-31' },
                  { label: '3º Bimestre', from: '-08-01', to: '-09-30' },
                  { label: '4º Bimestre', from: '-10-01', to: '-11-30' },
                ].map((preset) => {
              ...
              <div className="flex flex-wrap items-end gap-3">
                ...
                {appliedDateFrom && (
                  <span className="text-xs text-muted-foreground self-center">
                    Exibindo: {new Date(appliedDateFrom + 'T12:00:00').toLocaleDateString('pt-BR')} – {new Date(appliedDateTo + 'T12:00:00').toLocaleDateString('pt-BR')}
                  </span>
                )}
              </div>
