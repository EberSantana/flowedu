...
/**
 * Template de e-mail para definição de senha inicial (cadastro manual pelo admin)
 */
export function getSetPasswordEmailTemplate(setPasswordLink: string, userName: string, role: 'admin' | 'user'): string {
  const roleText = role === 'admin' ? 'Administrador' : 'Professor';
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Defina sua Senha - FlowEdu</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 40px 20px;">
    <tr>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 24px; color: #4a5568; font-size: 16px; line-height: 1.6;">
                Para acessar o sistema, você precisa definir sua senha. Clique no botão abaixo:
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding: 20px 0;">
                    <a href="${setPasswordLink}" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 6px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 6px rgba(102, 126, 234, 0.3);">
                      Definir Minha Senha →
                    </a>
                  </td>
                </tr>
              ...
              <div style="background-color: #fef3c7; padding: 16px; border-radius: 6px; border-left: 4px solid #f59e0b; margin: 24px 0;">
                <p style="margin: 0; color: #92400e; font-size: 14px;">
                  <strong>⚠️ Atenção:</strong> Este link expira em <strong>24 horas</strong>.
                </p>
              </div>
              ...
              <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e2e8f0;">
                <p style="margin: 0; color: #a0aec0; font-size: 13px; line-height: 1.6;">
                  <strong>Nota:</strong> Se você não esperava este e-mail, entre em contato com o administrador do sistema.
                </p>
              </div>
            </td>
          </tr>
...
/**
 * Envia e-mail para definição de senha inicial
 */
export async function sendSetPasswordEmail(
  ...
  const html = getSetPasswordEmailTemplate(setPasswordLink, userName, role);
  
  return sendEmail({
    to: email,
    subject: '🎓 Bem-vindo ao FlowEdu - Defina sua Senha',
    html,
  });
}
