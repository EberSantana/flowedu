...
# Anexo quantitativo completo da extração

Este anexo reproduz os agregados usados no relatório. Os valores são da base de produção da VPS e não contêm nomes, e-mails, matrículas, IPs ou respostas individuais.

## Uso histórico de IA por funcionalidade

| provider | model | feature | calls | successes | failures | promptTokens | completionTokens | totalTokens | users | firstAt | lastAt |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| groq | llama-3.3-70b-versatile | generate_exercise | 25 | 3 | 22 | 4489 | 5100 | 9589 | 0 | 2026-04-23 11:31:48 | 2026-07-23 16:39:01 |
| groq | llama-3.3-70b-versatile | student_analysis | 5 | 5 | 0 | 4931 | 3287 | 8218 | 0 | 2026-04-17 18:15:46 | 2026-04-30 21:16:34 |
| groq | llama-3.3-70b-versatile | generate_assessment | 3 | 3 | 0 | 3063 | 8751 | 11814 | 0 | 2026-04-17 22:03:06 | 2026-05-19 12:07:34 |
| groq | llama-3.3-70b-versatile | other | 3 | 1 | 2 | 248 | 181 | 429 | 0 | 2026-04-21 19:32:43 | 2026-04-21 19:32:44 |
| groq | llama-3.3-70b-versatile | student_ai_hints | 1 | 0 | 1 | 0 | 0 | 0 | 0 | 2026-09-11 17:19:34 | 2026-09-11 17:19:34 |

## Uso de IA na janela de 70 dias

| provider | model | feature | calls | successes | failures | totalTokens | users |
| --- | --- | --- | --- | --- | --- | --- | --- |
| groq | llama-3.3-70b-versatile | generate_exercise | 15 | 1 | 14 | 2817 | 0 |
| groq | llama-3.3-70b-versatile | student_ai_hints | 1 | 0 | 1 | 0 | 0 |

## Chamadas de IA por dia na janela

| day | calls | successes | failures |
| --- | --- | --- | --- |
| 2026-07-17 | 4 | 0 | 4 |
| 2026-07-21 | 6 | 0 | 6 |
| 2026-07-22 | 2 | 0 | 2 |
...
| status | attempts | students | firstAt | lastAt | avgScore | minScore | maxScore | avgPercentage | avgSeconds | passed |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| in_progress | 1 | 1 | 2026-03-18 17:33:33 | None | 0 | 0 | 0 | 0 | 0.0000 | 0 |
| submitted | 29 | 28 | 2026-03-18 18:39:37 | 2026-04-17 22:48:00 | 6.758620689655173 | 1 | 10 | 67.58620689655173 | 468.3103 | 22 |

## Progresso de tópicos

| status | rowCount | students | topics | firstAt | lastAt |
| --- | --- | --- | --- | --- | --- |
| completed | 203 | 54 | 81 | 2026-02-18 00:20:31 | 2026-07-03 14:52:29 |
| in_progress | 48 | 25 | 26 | 2026-03-06 00:06:59 | 2026-09-20 03:19:28 |

## Registros comportamentais

| behaviorType | events | students | firstAt | lastAt |
| --- | --- | --- | --- | --- |
| exercise_completion | 427 | 146 | 2026-03-18 16:51:55 | 2026-05-03 16:33:59 |

## Acessos por hora na janela
...
## Acessos por dia da semana na janela

| weekday | events | users |
| --- | --- | --- |
| 1 | 3 | 3 |
| 2 | 2 | 2 |
| 3 | 6 | 3 |
...
## Contagens de tabelas relevantes
...
| `students` | 366 |
| `subjects` | 16 |
| `subjectEnrollments` | 261 |
| `student_enrollments` | 1 |
| `learning_modules` | 73 |
| `learning_topics` | 180 |
| `student_topic_progress` | 251 |
| `assessments` | 0 |
| `assessment_questions` | 0 |
| `assessment_attempts` | 30 |
| `assessment_answers` | 580 |
| `student_exercises` | 0 |
| `student_exercise_attempts` | 0 |
| `student_exercise_answers` | 0 |
| `student_behaviors` | 427 |
| `ai_insights` | 4 |
| `ai_usage_logs` | 37 |
| `access_logs` | 1431 |
| `audit_logs` | 0 |
...
## Campos de rastreabilidade procurados

| Campo | Tabelas encontradas |
|---|---|
| `ai_model_version` | Nenhuma |
| `prompt_id` | Nenhuma |
| `ai_request_id` | Nenhuma |
| `ai_source` | Nenhuma |
| `revisedBy` | Nenhuma |
| `reviewedAt` | review_history |
| `edited_content` | Nenhuma |
| `diff` | Nenhuma |

## Nota de interpretação

Os agregados descrevem o que está persistido na produção. A ausência de um registro não prova que uma ação pedagógica não ocorreu fora do sistema. Da mesma forma, uma chamada de IA registrada não prova que sua saída foi entregue, publicada, revisada ou consumida por um aluno.

## Referências internas

[1]: /home/ubuntu/teacher_schedule_system/docs/reports/ICAART_2027_RESPOSTAS_BD_PRODUCAO_VPS.md "Relatório de respostas do ICAART na produção"
[2]: /home/ubuntu/teacher_schedule_system/analysis/icaart_2027_vps_aggregate_metrics.json "Agregados anonimizados da produção"
[3]: /home/ubuntu/teacher_schedule_system/scripts/icaart-vps-readonly-extract.cjs "Script reprodutível de extração somente leitura"
